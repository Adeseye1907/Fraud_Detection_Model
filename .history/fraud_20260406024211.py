...
st.markdown("<h1 style = 'color: #DD5746; text-align: center; font-size:60px; font-family: Monospace'>FRAUD DETECTION PREDICTION SYSTEM / M </h1>", unsafe_allow_html = True)
