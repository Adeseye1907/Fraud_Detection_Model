...
st.markdown("<h1 style = 'color: #DD5746; text-align: center; font-size:60px; font-family: Monospace'>FRAUD DETECTION PREDICTION MODEL </h1>", unsafe_allow_html = True)
...
st.image('pngwing.com fraud 2.png')
st.divider()
...
File "C:\Users\user\Desktop\Machine Learning\Project\Fruad detection\fraud.py", line 40, in <module>
