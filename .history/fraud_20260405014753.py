...
st.markdown(' tify users, with a focus on identifying patterns that predict disengagement. By analyzing listening behavior, ad interactions, and subscription preferences, the analysis seeks to develop a Critical Churn Risk Index (CCRI) that quantifies user vulnerability to churn. The findings will provide actionable insights for Spotify to refine its personalization strategies, optimize advertising placement, and design retention-focused interventions—ultimately enhancing user satisfaction and ensuring sustainable growth.Fraud detection is a critical component of **Data-Driven Decision Making Systems (DDDM)** in digital banking platforms 
